...
def log_and_raise_error(logger_arg: logging.Logger,
                        level: str,
...
def assert_and_log_error(logger_arg: logging.Logger,
                         level: str,
                         condition: bool,
                         message: str,
...
def logger_setup(logger_name: str,
                 format_string: str,
                 file_log_level: int,
...
class BaseLogger:
    ...
    def setup(self) -> logging.Logger:
        ...
        logger = logger_setup(self.logger_name,
                              self.format_string,
                              self.file_log_level,
                              self.console_log_level,
                              self.log_file_path)
...
class DataTypesLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='validation.data_types',
...
class PrepperLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='processors.Prepper',
...
class ValidatorsLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='validation.validators_models',
...
class LLMHandlerLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='processors.LLMHandler',
...
class BaseWorkflowLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='base_workflow',
...
class UnhandledErrorsLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='unhandled_errors',
...
class StringsToolsLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='tools.strings',
...
class TimeToolsLogger(BaseLogger):
    def __init__(self):
        super().__init__(logger_name='tools.time',
