...
def main():
    with LogBlock("Set file vars", logger):
        source_file = r"C:\Users\kylec\Documents\GitHub\CategoriGen\scratch\cinema test data\cin March 2024 - 10160.xlsx"
    ...
    with LogBlock('Preparing & appending Prepper output', logger):
        prepared_data = (Prepper()
                         ...
                         .set_id_column('RESPONSE_ID')
                         .set_data_columns(['ALL_COMMENTS'])
                         .set_data_dict())
        chain.append(
            title='prepared data',
